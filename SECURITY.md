...
If you discover a security vulnerability in Vivo Updates, please report it **privately** and practice responsible disclosure. [See how](https://docs.github.com/en/code-security/how-tos/report-and-fix-vulnerabilities/report-a-vulnerability/privately-reporting-a-security-vulnerability).
...
- Vulnerabilities that require modifying Vivo Updates itself to be exploitable
- Reports without any reasonable security impact
- Reports not related to Vivo Updates (For examples, issues related to Shizuku should be reported to Shizuku)
