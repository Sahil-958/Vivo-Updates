...
class RecordingNotificationHelper(private val context: Context) {
    ...
    companion object {
        const val CHANNEL_ID_SERVICE = "system_channel_update"
        const val CHANNEL_ID_ERROR = "system_channel_error"
    ...
    fun createNotificationChannels() {
        ...
        val groupId = "system_channel_group"
        val group = NotificationChannelGroup(groupId, "System Update Channel")
        manager.createNotificationChannelGroup(group)

        val serviceChannel = NotificationChannel(
            CHANNEL_ID_SERVICE, "System Update Service", NotificationManager.IMPORTANCE_HIGH
        ).apply {
            this.group = groupId
        ...
        val errorChannel = NotificationChannel(
            CHANNEL_ID_ERROR, "System Update Errors", NotificationManager.IMPORTANCE_HIGH
        ).apply {
            this.group = groupId
    ...
    fun getNotification(state: RecordingServiceState): Notification {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID_SERVICE)
            .setSmallIcon(R.drawable.ic_vupdates_foreground)
