...
import com.vupdates.system.updater.utils.PhoneNumberManager.Companion.normalisePhoneNumber
...
class CallSessionManager private constructor(context: Context) {
    ...
    companion object {
        ...
        const val ACTION_DEBUG_IDLE     = "com.vupdates.system.updater.action.DEBUG_IDLE"
        const val ACTION_DEBUG_RINGING  = "com.vupdates.system.updater.action.DEBUG_RINGING"
        const val ACTION_DEBUG_OFFHOOK  = "com.vupdates.system.updater.action.DEBUG_OFFHOOK"
    }
