...
import com.vupdates.system.updater.onboarding.OnboardingStatus
import com.vupdates.system.updater.ui.screens.DisclaimerScreen
import com.vupdates.system.updater.ui.screens.PermissionsScreen
import com.vupdates.system.updater.ui.screens.SettingsScreen
import com.vupdates.system.updater.ui.theme.VUpdatesTheme
import com.vupdates.system.updater.ui.viewmodels.AppNavigationViewModel
...
fun AppNavigationScreen() {
    ...
    VUpdatesTheme(darkTheme = darkTheme, dynamicColor = dynamicColor) {
        when (screenState) {
