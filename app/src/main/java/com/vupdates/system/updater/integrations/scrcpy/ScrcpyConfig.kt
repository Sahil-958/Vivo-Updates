...
package com.vupdates.system.updater.integrations.scrcpy
...
object ScrcpyConfig {
     ...
     *
     * IMPORTANT: The [context] passed here must belong to Vivo Updates, NOT to Shizuku or
     * the shell process.  Using the shell context would produce a path the app cannot write to.
     *
     * @param context The Vivo Updates app context.
