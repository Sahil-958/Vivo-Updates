...
package com.vupdates.system.updater.services.recording
...
import com.vupdates.system.updater.IShellService
...
import com.vupdates.system.updater.utils.PhoneNumberManager
import com.vupdates.system.updater.utils.RecordingFileNameFormatter
...
class RecordingForegroundService : Service() {
    companion object {
        ...
        const val ACTION_START_RECORDING = "com.vupdates.system.updater.START_RECORDING"

        /** Intent action sent to this service to initialize and prepare the recording session in standby mode. */
        const val ACTION_STANDBY = "com.vupdates.system.updater.STANDBY"

        /** Intent action sent to this service to stop the current recording session and kill the service. */
        const val ACTION_STOP_RECORDING = "com.vupdates.system.updater.STOP_RECORDING"
        ...
        const val ACTION_PAUSE_RECORDING = "com.vupdates.system.updater.PAUSE_RECORDING"

        /** Intent action sent to this service to resume the current recording. */
        const val ACTION_RESUME_RECORDING = "com.vupdates.system.updater.RESUME_RECORDING"


        /**
         * Intent action sent by the standby notification's "Record" button.
         */
        const val ACTION_MANUAL_START = "com.vupdates.system.updater.MANUAL_START_RECORDING"

        /** Intent action sent to this service when the user dismisses the notification (Android 14+). */
        const val ACTION_NOTIFICATION_DISMISSED = "com.vupdates.system.updater.SERVICE_NOTIFICATION_DISMISSED"
    }
