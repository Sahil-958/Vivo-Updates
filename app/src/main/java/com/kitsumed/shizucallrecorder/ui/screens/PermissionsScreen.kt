        ...
        Column(
            ...
            Column(
                ...
                val permissions = listOf(
                    ...
                    Triple(stringResource(R.string.permission_storage_label), stringResource(R.string.permission_storage_description), status.storageSelected to Icons.Default.Folder)
                )
